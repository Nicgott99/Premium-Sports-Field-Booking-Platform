...
function App() {
  ...
  // Filter fields based on search and sport
  ...
  const confirmBooking = async () => {
    try {
      const bookingData = {
        ...
        duration: 2,
        participants: selectedField.minBookingSize
      };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <header className="relative z-10 bg-black/30 backdrop-blur-xl border-b border-white/10 shadow-2xl">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center">
            <h1 className="text-6xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 mb-4 tracking-tight">
              🏆 PREMIUM SPORTS
            </h1>
            <div className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400 mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="relative">
              ...
              >
                ...
                {sports.map(sport => (
                  <option key={sport} value={sport} className="bg-gray-800">{sport}</option>
                ))}
              </select>
              ...
              >
                ...
                <div className="relative h-64 overflow-hidden">
                  <img
                    ...
                    onError={(e) => {
                      e.target.src = `https://images.unsplash.com/photo-1459865264687-595d652de67e?w=800&h=400&fit=crop`;
                    }}
                  />
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex items-center gap-2 text-gray-300">
                      ...
                      <span className="font-bold text-xl text-green-400">
                        {field.pricePerHour} {field.currency}
                      </span>
                    ...
                    <div className="flex items-center gap-2 text-gray-300">
                      <span className="text-lg">⏰</span>
                      <span className="font-medium">{field.availableSlots} slots available</span>
                    </div>
                    
                    <div className="flex items-center gap-2 text-gray-300">
                      <span className="text-lg">👥</span>
                      <span className="font-medium">Min {field.minBookingSize} players</span>
                    </div>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {field.amenities.slice(0, 4).map((amenity, index) => (
                        <span
                          key={index}
                  ...
                  <div className="flex items-center gap-2 text-gray-400 text-sm mb-6">
                    <span>📝</span>
                    <span>{field.reviews} premium reviews</span>
                  </div>
      ...
      {showBookingModal && selectedField && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 rounded-3xl p-8 max-w-md w-full border border-purple-500/50 shadow-2xl">
            ...
            <div className="space-y-4 mb-8">
              <div className="bg-white/10 rounded-2xl p-4">
                <h4 className="font-bold text-white text-lg">{selectedField.name}</h4>
                <p className="text-gray-300">{selectedField.sport} • {selectedField.location}</p>
              </div>
              
              <div className="bg-white/10 rounded-2xl p-4">
                <p className="text-gray-300">📅 Date: Today</p>
                <p className="text-gray-300">⏰ Time: 10:00 AM - 12:00 PM</p>
                <p className="text-gray-300">👥 Players: {selectedField.minBookingSize}</p>
                <p className="text-green-400 font-bold text-lg">💰 Total: {selectedField.pricePerHour * 2} {selectedField.currency}</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="flex-1 py-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
                🚀 Confirm Booking
              </button>
            </div>
