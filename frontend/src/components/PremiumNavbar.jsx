        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-xs text-gray-300 font-medium tracking-wide">Elite Platform</p>
            </div>
          </Link>
              ...
              <Link
                ...
                className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-300 ${
                  location.pathname === link.path
                    ? 'bg-gradient-to-r from-purple-500/30 to-pink-500/30 text-purple-300 border border-purple-400 shadow-lg shadow-purple-500/20'
                    : 'text-gray-300 hover:text-purple-300 hover:bg-purple-500/10 hover:border hover:border-purple-400/30'
                }`}
              >
                {link.label}
              </Link>
